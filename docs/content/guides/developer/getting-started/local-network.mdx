...
```
      ...
      --fullnode-port <FULLNODE_PORT>          Port to start the Fullnode RPC server on. Default port is 9000 [default: 9000]
      ...
      --indexer-port <INDEXER_PORT>            Port to start the Indexer RPC server on. Default port is 9124 [default: 9124]
